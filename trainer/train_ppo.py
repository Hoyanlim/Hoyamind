...
from model.model import HoyamindConfig, HoyamindForCausalLM  # MiniMind模型
...
class CriticModel(HoyamindForCausalLM):
...
if __name__ == "__main__":
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"Hoyamind-PPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
        wandb.init(
